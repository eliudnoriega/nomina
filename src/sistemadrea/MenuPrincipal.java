...
/*<<<<<<< HEAD
    private void jMenuItem_add_docActionPerformed(java.awt.event.ActionEvent evt) {                                                  
//        new addProductos(this, true).setVisible(true);
        //AgregarDocente.main(null); 
        new AgregarEmpleado(this, true).setVisible(true);
    }                                                 

    private void jMenuItem_add_estabActionPerformed(java.awt.event.ActionEvent evt) {                                                    
...
/*<<<<<<< HEAD
    private void jMenuItem_add_haberesActionPerformed(java.awt.event.ActionEvent evt) {                                                      
        // TODO add your handling code here:
        // Agregar_Planilla.main(null); 
        new AgregarHaberes(this, true).setVisible(true);
    }                                                     

    private void jMenuItem_mod_docActionPerformed(java.awt.event.ActionEvent evt) {                                                  
